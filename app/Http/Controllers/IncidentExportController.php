...
class IncidentExportController extends Controller
{
    ...
    public static function exportExcelResponse($incidents, string $period = 'week')
    {
        ...
        return response()->streamDownload(function () use ($incidents, $totalCount, $resolvedCount, $critCount, $warnCount, $resRate, $mttrFormatted, $period, $isEn) {
            ...
            echo '<style>
                ...
                .title-banner { background-color: #0020B2; color: #ffffff; font-size: 13pt; font-weight: bold; padding: 12px 16px; vertical-align: middle; letter-spacing: 0.5px; }
            ...
            // Header Banner Épuré Haute Lisibilité
            ...
            echo '<tr><td colspan="13" style="height:14px;"></td></tr>';

            // Data Table Headers (13 Colonnes Exhaustives)
            $thId      = 'ID';
            ...
            $thFin     = $isEn ? 'ESTIMATED FINANCIAL IMPACT' : 'IMPACT FINANCIER (FCFA)';
            ...
            echo '<tr>
                ...
                <th style="width:170px;text-align:right;">' . $thFin . '</th>
            ...
            foreach ($incidents as $inc) {
                ...
                $fin = $inc->financial_impact;
                $finText = $fin['status_badge_text'];
                ...
                echo "<tr class='{$rowClass}'>
                    ...
                    <td style='text-align:right;font-weight:bold;color:#059669;'>{$finText}</td>
            ...
            $footerMsg = $isEn 
                ? 'Document automatically generated by VigilCore Enterprise — Strict SLA Audit & Compliance Report — Douala Datacenter.'
                : 'Document certifié généré automatiquement par VigilCore Enterprise — Audit SLA & Conformité Haute Disponibilité — Douala Datacenter.';

            echo '<tr><td colspan="13" style="height:12px;"></td></tr>';
            echo '<tr><td colspan="13" class="footer">' . $footerMsg . '</td></tr>';
    ...
    public static function exportCsvResponse($incidents, string $period = 'week')
    {
        ...
        return response()->streamDownload(function () use ($incidents, $isEn) {
            ...
            $headers = $isEn
                ? ['ID', 'Start Time (WAT)', 'Resolution Time (WAT)', 'MTTR Duration', 'Service / Title', 'Severity', 'Status', 'Error Code', 'Financial Impact', 'Root Cause', 'Resolution Note', 'Source', 'Description']
                : ['ID', 'Heure Debut (WAT)', 'Heure Resolution (WAT)', 'Duree MTTR', 'Service / Intitule', 'Severite', 'Statut', 'Code Erreur', 'Impact Financier (FCFA)', 'Cause Racine', 'Note de Cloture', 'Source', 'Description'];
